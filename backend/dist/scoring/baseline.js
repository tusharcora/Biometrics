...
exports.sleepDurationZVsGoal = sleepDurationZVsGoal;
exports.sleepDurationZRawVsGoal = sleepDurationZRawVsGoal;
function median(values) {
    if (values.length === 0)
        throw new Error('median of an empty series');
 ...
 */
function computeBaseline(history, cfg) {
 ...
 */
function flooredSpread(baseline, cfg, metric) {
 ...
 */
function zScore(value, baseline, cfg, metric) {
 ...
 */
function sleepDurationZVsGoal(minutesAsleep, goalMinutes, baseline, cfg) {
...
function sleepDurationZRawVsGoal(minutesAsleep, goalMinutes, baseline, cfg) {
    if (baseline.coldStart)
        return null;
